...
uint32_t mock_pinMode_u32CalledTimes;
...
uint32_t mock_digitalRead_u32CalledTimes;
...
uint32_t mock_digitalWrite_u32CalledTimes;
...
uint32_t mock_pwait_u32CalledTimes;
