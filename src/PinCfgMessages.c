/**
 * @file PinCfgMessages.c
 * @brief Implementation of error codes and message strings for PinCfg parser
 */
...
static const char *_errorMessages[] = {
    ...
    "Invalid byte offset",                // 28 - ERR_INVALID_BYTE_OFFSET
    "Invalid byte count",                 // 29 - ERR_INVALID_BYTE_COUNT
    "Type not implemented",               // 30 - ERR_TYPE_NOT_IMPLEMENTED
    "Invalid I2C params",                 // 31 - ERR_INVALID_I2C_PARAMS
    "Invalid I2C address",                // 32 - ERR_INVALID_I2C_ADDRESS
    "Invalid I2C command",                // 33 - ERR_INVALID_I2C_CMD
    "Invalid data size",                  // 34 - ERR_INVALID_DATA_SIZE
    "Invalid global config"               // 35 - ERR_INVALID_GLOBAL_CFG
};
#endif
...
// Unified error logging - automatically handles USE_ERROR_MESSAGES mode
