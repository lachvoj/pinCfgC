...
/**
 * @brief Analog measurement implementation
 * 
 * Returns raw ADC value as 2 bytes (big-endian uint16).
 * All processing (averaging, voltage conversion, scaling) handled by Sensor layer.
 */
static ISENSORMEASURE_RESULT_T AnalogMeasure_eMeasure(
    ISENSORMEASURE_T *pSelf,
    uint8_t *pu8Buffer,
