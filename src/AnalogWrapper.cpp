/**
 * @file AnalogWrapper.cpp
 * @brief C++ implementation of Analog wrapper for C code
 * 
 * Provides platform-agnostic analog ADC interface.
 * Supports three modes:
 * 1. UNIT_TEST - Uses mock for testing
 * 2. STM32 HAL - Uses STM32 HAL ADC functions (auto-detected via ARDUINO_ARCH_STM32*)
 * 3. Default - Uses Arduino analogRead() API
 * 
...
/**
 * @brief Set ADC handle to use for Analog operations
 */
...
/**
 * @brief Configure pin-to-channel mapping
 */
