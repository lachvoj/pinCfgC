...
extern "C"
{
    ...
    uint8_t Wire_u8EndTransmission(bool bSendStop)
    {
        ...
        switch (eStatus)
        {
        case HAL_OK: return 0;      // Success
        case HAL_ERROR: return 4;   // Other error
        case HAL_TIMEOUT: return 4; // Timeout (treated as other error)
        case HAL_BUSY: return 4;    // Bus busy
        default: return 4;
        }
#else
