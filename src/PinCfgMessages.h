...
typedef enum PINCFG_ERROR_CODE_E
{
    ...
    ERR_EVENT_PUBLISHER_NOT_FOUND,
    ERR_SOURCE_NOT_FOUND,
    ERR_INVALID_EVENT_TYPE,
    ERR_INVALID_EVENT_DATA,
...
#define LOG_WARNING(psPrms, prefix, errorCode) PinCfgMessages_logParseError(psPrms, prefix, errorCode, false)

#define LOG_ERROR(psPrms, prefix, errorCode) PinCfgMessages_logParseError(psPrms, prefix, errorCode, true)
